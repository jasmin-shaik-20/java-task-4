...
public class PartTimeEmployee extends EmployeeDetails{
    ...
    private static Logger logger = LogManager.getLogger(PartTimeEmployee.class);
    ...
    public static void employeeAge(int id,int age) throws SQLException
    {
        try {
            ...
            if (rows > 0) {
                ...
                logger.debug("Age is not modified");
            }
        }
        finally {
            conn.close();
    ...
    public static void employeeSalary(int id,int salary) throws SQLException
    {
        try {
            ...
            if (rows > 0) {
                ...
                logger.error("Salary is not modified Successfully");
            }
        }
        finally {
            conn.close();
